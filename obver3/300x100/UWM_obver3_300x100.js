...
// stage content:
(lib.UWM_obver3_300x100 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_2.setTransform(164,11);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(215).to({_off:false},0).to({x:157,y:11},6,cjs.Ease.quadOut).wait(28));

	// CTA
	this.instance_4 = new lib.CTA();
	this.instance_4.setTransform(306.05,26.8,1,1,0,0,0,0,15.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(222).to({_off:false},0).to({x:168.65},7,cjs.Ease.quadOut).wait(20));
...
p.nominalBounds = new cjs.Rectangle(-155,46,693.4,68.3);
// library properties:
lib.properties = {
