...
lib.ssMetadata = [
		{name:"UWM_orthover3_970x250_atlas_NP_1", frames: [[0,0,1940,500]]}
];
...
(lib._970x250ortho3 = function() {
	this.initialize(ss["UWM_orthover3_970x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._970x250ortho3();
...
// stage content:
(lib.UWM_orthover3_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(957.15,176.55,1.5988,1.5988,0,0,0,-7.4,-47);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#32006E").s().p("AgHg1IAPADIgPBog");
	this.shape_1.setTransform(1094.225,149);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance}]}).wait(108));

	// UWMed logo mark
	this.instance_1 = new lib.UWMed_logomark();
	this.instance_1.setTransform(791.85,125.45,0.6662,0.6662,0,0,0,0.6,0.6);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(48).to({y:150.65},9,cjs.Ease.quadInOut).wait(51));

	// slash
	this.instance_2 = new lib.slash();
	this.instance_2.setTransform(809.4,78.05,1.3324,1.3324);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(88).to({_off:false},0).wait(20));

	// mask (mask)
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_58 = new cjs.Graphics().p("AEyPoICduGIABAAIAzkoMBTDAAAIjSSug");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_graphics_58,x:582.97,y:100.0043}).wait(50));

	// SUB ServLine
	this.instance_3 = new lib.SUBServLine();
	this.instance_3.setTransform(562.25,75.4,1.3324,1.3324);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(58).to({_off:false},0).to({x:799.4,y:78.05},6,cjs.Ease.quadOut).wait(44));

	// CTA
	this.instance_4 = new lib.CTA();
	this.instance_4.setTransform(1084.65,99.1,1.3324,1.3324,0,0,0,0,15.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(81).to({_off:false},0).to({regX:0.1,x:812.8},7,cjs.Ease.quadOut).wait(20));

	// BKGD footer
	this.instance_5 = new lib.BKGDfooter();
	this.instance_5.setTransform(2376.55,125.3,2.778,2.778,0,0,0,614,0.1);
...
p.nominalBounds = new cjs.Rectangle(484.5,124.5,1272.7,127.19999999999999);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_970x250_atlas_NP_1.jpg", id:"UWM_orthover3_970x250_atlas_NP_1"}
	],
	preloads: []
};
