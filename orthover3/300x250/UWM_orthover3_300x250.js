...
lib.ssMetadata = [
		{name:"UWM_orthover3_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib._300x250ortho3gold = function() {
	this.initialize(ss["UWM_orthover3_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x250ortho3gold();
...
// stage content:
(lib.UWM_orthover3_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({x:9.1,y:207.45},6,cjs.Ease.quadInOut).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.instance_1}]}).to({state:[{t:this.instance_2}]},48).to({state:[{t:this.instance_3}]},6).wait(51));
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(48).to({_off:false},0).to({_off:true,y:201.7},6,cjs.Ease.quadInOut).wait(51));

	// UWMed logo mark
	this.instance_4 = new lib.UWMed_logomark();
	this.instance_4.setTransform(150.8,221.3,0.57,0.57,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(48).to({x:150.3,y:218.3},6,cjs.Ease.quadInOut).wait(51));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(85).to({_off:false},0).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(55).to({_off:false},0).to({x:159,y:162},6,cjs.Ease.quadOut).wait(44));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(78).to({_off:false},0).to({x:172.65},7,cjs.Ease.quadOut).wait(20));

	// BKGD footer
	this.instance_8 = new lib.BKGDfooter();
	this.instance_8.setTransform(613.8,181,1,1,0,0,0,613.8,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(48).to({y:151},6,cjs.Ease.quadInOut).wait(51));
...
p.nominalBounds = new cjs.Rectangle(-14.3,124.5,436.7,169.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_300x250_atlas_NP_1.jpg", id:"UWM_orthover3_300x250_atlas_NP_1"}
	],
	preloads: []
};
