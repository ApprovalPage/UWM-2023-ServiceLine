...
lib.ssMetadata = [
		{name:"UWM_orthover3_300x1050_atlas_NP_1", frames: [[0,0,600,2100]]}
];
...
(lib._300x1050ortho3 = function() {
	this.initialize(ss["UWM_orthover3_300x1050_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x1050ortho3();
...
// stage content:
(lib.UWM_orthover3_300x1050 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(150.3,983.3,0.57,0.57,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({y:1003.3},6,cjs.Ease.quadInOut).wait(51));

	// SUB ServLine
	this.instance_1 = new lib.SUBServLine();
	this.instance_1.setTransform(-56,923);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(55).to({_off:false},0).to({x:154},6,cjs.Ease.quadOut).wait(44));

	// CTA
	this.instance_2 = new lib.CTA();
	this.instance_2.setTransform(346.05,961.8,1,1,0,0,0,0,15.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(78).to({_off:false},0).to({x:149.65},7,cjs.Ease.quadOut).wait(20));

	// BKGD footer
	this.instance_3 = new lib.BKGDfooter();
	this.instance_3.setTransform(613.8,910,1,1.176,0,0,0,613.8,0);

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(105));

	// PIC
	this.instance_4 = new lib.PIC1();
	this.instance_4.setTransform(150,0);
...
p.nominalBounds = new cjs.Rectangle(14.8,524.5,393.09999999999997,526);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_300x1050_atlas_NP_1.jpg", id:"UWM_orthover3_300x1050_atlas_NP_1"}
	],
	preloads: []
};
