...
lib.ssMetadata = [
		{name:"UWM_orthover3_970x90_atlas_NP_1", frames: [[0,0,1940,180]]}
];
...
(lib._970x90ortho3 = function() {
	this.initialize(ss["UWM_orthover3_970x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._970x90ortho3();
...
// stage content:
(lib.UWM_orthover3_970x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(960.3,52.9,1.2,1.2,0,0,0,-7.4,-47);
	...
	this.instance_1.setTransform(818.75,45.25,0.5,0.5,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(48).to({y:52.9},9,cjs.Ease.quadInOut).wait(51));

	// slash
	this.instance_2 = new lib.slash();
	this.instance_2.setTransform(831.5,6);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_58 = new cjs.Graphics().p("ATsHCIB2qkIABAAIAmjfMA+VAAAIieODg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_graphics_58,x:540.575,y:45}).wait(50));

	// SUB ServLine
	this.instance_3 = new lib.SUBServLine();
	this.instance_3.setTransform(664.1,4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(58).to({_off:false},0).to({x:827.1,y:6},6,cjs.Ease.quadOut).wait(44));

	// CTA
	this.instance_4 = new lib.CTA();
	this.instance_4.setTransform(1056.05,21.8,1,1,0,0,0,0,15.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(81).to({_off:false},0).to({x:834.65},7,cjs.Ease.quadOut).wait(20));

	// BKGD footer
	this.instance_5 = new lib.BKGDfooter();
	this.instance_5.setTransform(1303.8,45,1,1,0,0,0,613.8,0);
...
p.nominalBounds = new cjs.Rectangle(484.5,41.3,687.9000000000001,68);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_970x90_atlas_NP_1.jpg", id:"UWM_orthover3_970x90_atlas_NP_1"}
	],
	preloads: []
};
