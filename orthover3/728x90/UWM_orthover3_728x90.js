...
lib.ssMetadata = [
		{name:"UWM_orthover3_728x90_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90ortho3 = function() {
	this.initialize(ss["UWM_orthover3_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._728x90ortho3();
...
// stage content:
(lib.UWM_orthover3_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(718.3,52.9,1.2,1.2,0,0,0,-7.4,-47);
	...
	this.instance_1.setTransform(576.75,45.25,0.5,0.5,0,0,0,0.5,0.5);
	...
	this.instance_2.setTransform(591,6);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_58 = new cjs.Graphics().p("AAyHCIB1qkIABAAIAnjfMA+UAAAIidODg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(58).to({graphics:mask_graphics_58,x:419.525,y:45}).wait(50));

	// SUB ServLine
	this.instance_3 = new lib.SUBServLine();
	this.instance_3.setTransform(422,4);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(58).to({_off:false},0).to({x:587,y:6},6,cjs.Ease.quadOut).wait(44));

	// CTA
	this.instance_4 = new lib.CTA();
	this.instance_4.setTransform(734.05,21.8,1,1,0,0,0,0,15.8);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(81).to({_off:false},0).to({x:595.65},7,cjs.Ease.quadOut).wait(20));

	// BKGD footer
	this.instance_5 = new lib.BKGDfooter();
	this.instance_5.setTransform(1061.8,45,1,1,0,0,0,613.8,0);
...
p.nominalBounds = new cjs.Rectangle(363.5,41.3,486.9,68);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_728x90_atlas_NP_1.jpg", id:"UWM_orthover3_728x90_atlas_NP_1"}
	],
	preloads: []
};
