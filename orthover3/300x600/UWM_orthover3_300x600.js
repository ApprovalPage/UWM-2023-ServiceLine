...
lib.ssMetadata = [
		{name:"UWM_orthover3_300x600_atlas_NP_1", frames: [[0,0,600,1200]]}
];
...
(lib._300x600ortho3 = function() {
	this.initialize(ss["UWM_orthover3_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x600ortho3();
...
// stage content:
(lib.UWM_orthover3_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance.setTransform(150.3,531.3,0.57,0.57,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(48).to({y:551.3},6,cjs.Ease.quadInOut).wait(51));

	// SUB ServLine
	this.instance_1 = new lib.SUBServLine();
	this.instance_1.setTransform(-56,471);
	...
	this.instance_2.setTransform(346.05,509.8,1,1,0,0,0,0,15.8);
	...
	this.instance_3.setTransform(613.8,460,1,1.176,0,0,0,613.8,0);
...
p.nominalBounds = new cjs.Rectangle(14.8,299.5,393.09999999999997,301);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_orthover3_300x600_atlas_NP_1.jpg", id:"UWM_orthover3_300x600_atlas_NP_1"}
	],
	preloads: []
};
