...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(222).to({_off:false},0).to({x:164.65},7,cjs.Ease.quadOut).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(112).to({_off:false},0).to({x:149},7,cjs.Ease.quadOut).wait(33).to({x:-17},7,cjs.Ease.quadIn).to({_off:true},1).wait(89));
