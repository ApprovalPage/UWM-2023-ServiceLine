...
lib.ssMetadata = [
		{name:"UWM_neuro_768x90_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90neuro = function() {
	this.initialize(ss["UWM_neuro_768x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_neuro_768x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_768x90_atlas_NP_1.jpg", id:"UWM_neuro_768x90_atlas_NP_1"}
	],
	preloads: []
};
