...
lib.ssMetadata = [
		{name:"UWM_neuro_768x1024_atlas_NP_1", frames: [[0,0,1536,2048]]}
];
...
(lib._768x1024neuro = function() {
	this.initialize(ss["UWM_neuro_768x1024_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._768x1024neuro();
...
// stage content:
(lib.UWM_neuro_768x1024 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_768x1024_atlas_NP_1.jpg", id:"UWM_neuro_768x1024_atlas_NP_1"}
	],
	preloads: []
};
