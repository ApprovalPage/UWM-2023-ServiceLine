...
lib.ssMetadata = [
		{name:"UWM_neuro_970x90_atlas_NP_1", frames: [[0,0,1940,180]]}
];
...
(lib._970x90neuro = function() {
	this.initialize(ss["UWM_neuro_970x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._970x90neuro();
...
// stage content:
(lib.UWM_neuro_970x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_970x90_atlas_NP_1.jpg", id:"UWM_neuro_970x90_atlas_NP_1"}
	],
	preloads: []
};
