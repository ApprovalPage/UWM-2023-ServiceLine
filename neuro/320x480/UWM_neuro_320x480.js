...
lib.ssMetadata = [
		{name:"UWM_neuro_320x480_atlas_NP_1", frames: [[0,0,600,1200]]}
];
...
(lib._300x600neuro = function() {
	this.initialize(ss["UWM_neuro_320x480_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x600neuro();
...
// stage content:
(lib.UWM_neuro_320x480 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_5.setTransform(326.45,402.95,1.0667,1.0667,0,0,0,0,15.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(238).to({_off:false},0).to({regX:0.1,x:59.8},7,cjs.Ease.quadOut).wait(20));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_320x480_atlas_NP_1.jpg", id:"UWM_neuro_320x480_atlas_NP_1"}
	],
	preloads: []
};
