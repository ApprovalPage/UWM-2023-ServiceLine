...
lib.ssMetadata = [
		{name:"UWM_neuro_480x320_atlas_NP_1", frames: [[0,0,960,640]]}
];
...
(lib._480x320neuro = function() {
	this.initialize(ss["UWM_neuro_480x320_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._480x320neuro();
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neuro_480x320_atlas_NP_1.jpg", id:"UWM_neuro_480x320_atlas_NP_1"}
	],
	preloads: []
};
