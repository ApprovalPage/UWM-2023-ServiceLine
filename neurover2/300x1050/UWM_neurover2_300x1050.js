...
lib.ssMetadata = [
		{name:"UWM_neurover2_300x1050_atlas_NP_1", frames: [[0,0,600,2100]]}
];
...
(lib._300x1050neuro2 = function() {
	this.initialize(ss["UWM_neurover2_300x1050_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x1050neuro2();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(43.025,25.375);
	...
	this.shape_1.setTransform(29.925,25.375);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#32006E").s().p("Ag6BHIAAiJQAZgEAXAAQAjAAARAMQARANAAAbQAAAYgRANQgRANgfAAIgIAAIgFAAIAAAngAgTgqIAAAvIANAAQAOAAAHgFQAGgFABgNQgBgNgGgGQgIgGgNAAg");
	this.shape_2.setTransform(16.9,25.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_3.setTransform(3.125,25.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#32006E").s().p("Ag0BGIAAiLIAnAAIAABtIBCAAIAAAeg");
	this.shape_4.setTransform(-9.525,25.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#32006E").s().p("AgSBGIAAiLIAmAAIAACLg");
	this.shape_5.setTransform(-19.6,25.375);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#32006E").s().p("Ag6BHIAAiJQAZgEAYAAQAhAAASAMQARANAAAbQAAAYgQANQgSANgfAAIgJAAIgEAAIAAAngAgTgqIAAAvIANAAQAOAAAHgFQAGgFAAgNQAAgNgGgGQgIgGgNAAg");
	this.shape_6.setTransform(-29.75,25.275);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_7.setTransform(-43.525,25.375);
	...
	this.shape_11.setTransform(17.975,7.625);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_12.setTransform(5.225,7.625);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#32006E").s().p("AAXBHIgjgxIgIAAIgGAAIAAAxIgmAAIAAiIIAZgEIAYgBQAiAAAQALQARAMAAAXQAAAPgHAJQgIAKgNAGIApA3gAgagqIAAAlIAQABQAMAAAHgEQAGgFABgLQgBgKgGgFQgHgFgMAAQgIAAgIACg");
	this.shape_13.setTransform(-8.5,7.525);
	...
	this.shape_14.setTransform(-24.375,7.725);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#32006E").s().p("Ag6BGIAAgUIBChZIhBAAIAAgeIByAAIAAAUIhABZIBBAAIAAAeg");
	this.shape_15.setTransform(-38.95,7.625);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#32006E").s().p("AgSBGIAAiLIAlAAIAACLg");
	this.shape_16.setTransform(-49,7.625);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_17.setTransform(-58.875,7.625);
	...
	this.shape_18.setTransform(-72.075,7.625);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD2b, new cjs.Rectangle(-89.1,-6.9,178.2,45.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(56.775,5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#32006E").s().p("AgMAsIAAhYIAYAAIAABYg");
	this.shape_1.setTransform(49.35,5);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAATIAtAAIAAARg");
	this.shape_2.setTransform(39.325,5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#32006E").s().p("AgkAsIAAgMIAog5IgoAAIAAgTIBIAAIAAAOIgoA4IApAAIAAASg");
	this.shape_3.setTransform(30.6,5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#32006E").s().p("AgLAsIAAhYIAYAAIAABYg");
	this.shape_4.setTransform(24.1,5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#32006E").s().p("AghAsIAAhYIAZAAIAABGIAqAAIAAASg");
	this.shape_5.setTransform(18.275,5);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#32006E").s().p("AAYAsIgHgVIghAAIgHAVIgXAAIAdhYIAjAAIAdBYgAALAFIgLgiIgKAiIAVAAg");
	this.shape_6.setTransform(8.95,5);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#32006E").s().p("AgLAsIAAhYIAXAAIAABYg");
	this.shape_7.setTransform(1.75,5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#32006E").s().p("AgXAjQgNgLABgYQAAgNAFgLQAHgKALgFQAMgGARAAQAKAAAKACIAAATIgSgCQgLABgGACQgGADgDAGQgDAFAAAJQAAAJADAHQAEAFAEADQAHACAKABQAIgBALgCIAAATIgKACIgLAAQgZABgOgLg");
	this.shape_8.setTransform(-4.65,5);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAATIAtAAIAAARg");
	this.shape_9.setTransform(-13.175,5);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#32006E").s().p("AgkAtIAAhWQAQgDAOAAQAWAAALAIQAKAIAAARQAAAPgKAIQgLAJgTAAIgGAAIgCAAIAAAYgAgLgbIAAAeIAIABQAIgBAEgDQAFgDAAgIQAAgIgFgEQgEgEgIAAg");
	this.shape_10.setTransform(-22.025,4.95);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#32006E").s().p("AgSAsIgOgCIAAgSIAOACIAOABQAHABAEgDQADgCAAgEIAAgDIgEgEIgGgCIgIgCQgNgCgGgGQgHgGAAgLQAAgNAKgHQALgHAUgBIAMABIALACIAAASIgLgCIgLAAQgJAAgFACQgDACAAAEIABADIACADIAGACIAIACQANAEAHAEQAHAHAAALQAAAIgFAHQgFAGgIAEQgJACgMAAIgOgBg");
	this.shape_11.setTransform(-30.75,5);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAATIAtAAIAAARg");
	this.shape_12.setTransform(-42.575,5);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#32006E").s().p("AASAsIgSg+IgRA+IgfAAIgZhYIAZAAIARBDIAThDIAaAAIASBEIAShEIAYAAIgZBYg");
	this.shape_13.setTransform(-54.725,5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(-109,-4.9,218,19), null);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#2F1065").s().p("AguA7IAAh1IBcAAIAAAYIg8AAIAAAWIAzAAIAAAXIgzAAIAAAYIA9AAIAAAYg");
	this.shape_1.setTransform(36.475,12.575);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#2F1065").s().p("AATA8IgdgqIgHAAIgFAAIAAAqIgfAAIAAhzIAUgCIAVgCQAcAAAOAKQANAKAAATQAAAMgFAIQgHAJgLAFIAjAugAgWgkIAAAhIANAAQALAAAFgEQAGgEAAgJQAAgJgGgDQgFgFgKAAIgOABg");
	this.shape_2.setTransform(24.85,12.5);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2F1065").s().p("AAfA7IgJgdIgsAAIgJAdIgfAAIAnh1IAvAAIAnB1gAAOAGIgOguIgOAuIAcAAg");
	this.shape_3.setTransform(11.575,12.575);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2F1065").s().p("AgeAuQgSgPAAgfQAAgTAIgNQAJgOAPgHQAQgHAWAAQAOAAANADIAAAZQgMgCgMAAQgOAAgIADQgIAEgEAIQgEAHAAAMQAAANAEAIQAEAHAHAEQAIAEAOAAQAMAAANgEIAAAZIgOADIgPABQghAAgRgPg");
	this.shape_4.setTransform(-0.575,12.575);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#2F1065").s().p("AgsA7IAAh1IAhAAIAABcIA4AAIAAAZg");
	this.shape_5.setTransform(-15.825,12.575);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#2F1065").s().p("AAfA7IgJgdIgsAAIgJAdIgfAAIAnh1IAvAAIAnB1gAAOAGIgOguIgOAuIAcAAg");
	this.shape_6.setTransform(-28.125,12.575);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#2F1065").s().p("AgeAuQgSgPAAgfQAAgTAIgNQAJgOAPgHQAQgHAWAAQAOAAANADIAAAZQgMgCgMAAQgOAAgIADQgIAEgEAIQgEAHAAAMQAAANAEAIQAEAHAHAEQAIAEAOAAQAMAAANgEIAAAZIgOADIgPABQghAAgRgPg");
	this.shape_7.setTransform(-40.275,12.575);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#2F1065").s().p("AgPA7IAAh1IAfAAIAAB1g");
	this.shape_8.setTransform(-48.825,12.575);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#2F1065").s().p("AgiAuQgTgPAAgfQAAgdATgPQATgQAkAAQAPAAAOADIAAAZQgNgCgNAAQgPAAgJADQgKAEgFAIQgEAIAAAMQAAASAKAIQAJAJATAAIAEAAIAAgiIAfAAIAAA4QgSADgPAAQglAAgSgPg");
	this.shape_9.setTransform(-58.3,12.575);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#2F1065").s().p("AggA2QgOgHgIgNQgHgOAAgUQAAgTAHgOQAIgNAOgHQAOgHASAAQATAAAOAHQAOAHAIAOQAHANAAATQAAAUgHAOQgIANgOAHQgOAHgTAAQgSAAgOgHgAgUgbQgIAJAAASQAAATAIAIQAHAJANAAQAOAAAHgIQAIgJAAgSQAAgSgIgJQgHgJgOAAQgNAAgHAIg");
	this.shape_10.setTransform(-71.625,12.575);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#2F1065").s().p("AgsA7IAAh1IAhAAIAABcIA4AAIAAAZg");
	this.shape_11.setTransform(-83.425,12.575);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#2F1065").s().p("AggA2QgOgHgIgNQgHgOAAgUQAAgTAHgOQAIgNAOgHQAOgHASAAQATAAAOAHQAOAHAIAOQAHANAAATQAAAUgHAOQgIANgOAHQgOAHgTAAQgSAAgOgHgAgUgbQgIAJAAASQAAATAIAIQAHAJANAAQAOAAAHgIQAIgJAAgSQAAgSgIgJQgHgJgOAAQgNAAgHAIg");
	this.shape_12.setTransform(-96.225,12.575);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2F1065").s().p("AATA8IgdgqIgHAAIgEAAIAAAqIghAAIAAhzIAVgCIAVgCQAcAAAOAKQAOAKgBATQAAAMgFAIQgHAJgLAFIAiAugAgVgkIAAAhIAMAAQALAAAFgEQAGgEAAgJQAAgJgGgDQgFgFgLAAIgMABg");
	this.shape_13.setTransform(-109,12.5);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#2F1065").s().p("AgpAvQgNgNAAgaIAAhDIAgAAIAABGQAAANAGAFQAGAGAKAAQAMAAAGgGQAFgFAAgNIAAhGIAgAAIAABDQAAAagNANQgNANgdAAQgbAAgOgNg");
	this.shape_14.setTransform(-122.425,12.65);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#2F1065").s().p("AguA7IAAh1IBcAAIAAAYIg8AAIAAAWIAzAAIAAAXIgzAAIAAAYIA9AAIAAAYg");
	this.shape_15.setTransform(-134.575,12.575);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#2F1065").s().p("AAYA7IgxhHIAABHIgfAAIAAh1IAhAAIAxBHIAAhHIAfAAIAAB1g");
	this.shape_16.setTransform(-147.475,12.575);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#2F1065").s().p("AgQA7IAAhcIgnAAIAAgZIBvAAIAAAZIgoAAIAABcg");
	this.shape_17.setTransform(-165.025,12.575);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#2F1065").s().p("AguA7IAAh1IBcAAIAAAYIg8AAIAAAWIAzAAIAAAXIgzAAIAAAYIA9AAIAAAYg");
	this.shape_18.setTransform(-176.375,12.575);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#2F1065").s().p("AgiAuQgTgPAAgfQAAgdATgPQAUgQAjAAQAQAAANADIAAAZQgNgCgNAAQgPAAgJADQgKAEgEAIQgFAIAAAMQAAASAJAIQAKAJATAAIAEAAIAAgiIAfAAIAAA4QgSADgPAAQgkAAgTgPg");
	this.shape_19.setTransform(-188.9,12.575);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-208.9,0,270.7,24), null);
...
// stage content:
(lib.UWM_neurover2_300x1050 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	// pic divider
	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FBCE34").s().p("EgXbAjWIAAhkMAu3AAAIAABkgEgXbghxIAAhkMAu3AAAIAABkg");
	this.shape_1.setTransform(150,226.75);
	...
	this.instance_2.setTransform(150.3,981.3,0.57,0.57,0,0,0,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(208).to({y:1001.3},6,cjs.Ease.quadInOut).wait(51));

	// CTA
	this.instance_3 = new lib.CTA();
	this.instance_3.setTransform(496.05,946.8,1,1,0,0,0,0,15.8);
	...
	this.instance_6.setTransform(-89.45,855,1.4286,1.4286);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({_off:false},0).to({x:141.05},7,cjs.Ease.quadOut).wait(98));

	// HEAD2c
	this.instance_7 = new lib.HEAD2c();
	this.instance_7.setTransform(-93.05,855.65,1.4286,1.4286);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(112).to({_off:false},0).to({x:141.15},7,cjs.Ease.quadOut).wait(33).to({x:-93.05},7,cjs.Ease.quadIn).to({_off:true},1).wait(105));

	// HEAD2b
	this.instance_8 = new lib.HEAD2b();
	this.instance_8.setTransform(-93.05,855.65,1.4286,1.4286);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(64).to({_off:false},0).to({x:141.05},7,cjs.Ease.quadOut).wait(33).to({x:-93.05},7,cjs.Ease.quadIn).to({_off:true},1).wait(153));

	// HEAD2a
	this.instance_9 = new lib.HEAD2a();
	this.instance_9.setTransform(-93.05,855.65,1.4286,1.4286);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(16).to({_off:false},0).to({x:141.05},7,cjs.Ease.quadOut).wait(33).to({x:-93.05},7,cjs.Ease.quadIn).to({_off:true},1).wait(201));
...
p.nominalBounds = new cjs.Rectangle(-401.1,524.5,959,526);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_300x1050_atlas_NP_1.jpg", id:"UWM_neurover2_300x1050_atlas_NP_1"}
	],
	preloads: []
};
