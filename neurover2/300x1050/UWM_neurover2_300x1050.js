...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(266.05,952.8,1.3,1.3,0,0,0,0,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({regX:0.1,x:29.75},7,cjs.Ease.quadOut).wait(20));
	...
	this.instance_6.setTransform(-62.9,859.5,1.1,1.1);
	...
	this.instance_7.setTransform(-66.15,860.25,1.1,1.1,0,0,0,-0.1,0.1);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(112).to({_off:false},0).to({regX:0.1,x:141.1},7,cjs.Ease.quadOut).wait(33).to({regX:-0.1,x:-66.15},7,cjs.Ease.quadIn).to({_off:true},1).wait(105));

	// HEAD2b
	this.instance_8 = new lib.HEAD2b();
	this.instance_8.setTransform(-66.2,860.25,1.1,1.1,0,0,0,-0.1,0.1);
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(64).to({_off:false},0).to({regX:0.1,x:141.1},7,cjs.Ease.quadOut).wait(33).to({regX:-0.1,x:-66.2},7,cjs.Ease.quadIn).to({_off:true},1).wait(153));

	// HEAD2a
	this.instance_9 = new lib.HEAD2a();
	this.instance_9.setTransform(-66.2,860.25,1.1,1.1,0,0,0,-0.1,0.1);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(16).to({_off:false},0).to({regX:0.1,x:141.1},7,cjs.Ease.quadOut).wait(33).to({regX:-0.1,x:-66.2},7,cjs.Ease.quadIn).to({_off:true},1).wait(201));
...
p.nominalBounds = new cjs.Rectangle(-401.1,524.5,944.1,526);
// library properties:
lib.properties = {
