...
lib.ssMetadata = [
		{name:"UWM_neurover2_970x250_atlas_NP_1", frames: [[0,0,1940,500]]}
];
...
(lib._970x250neuro2 = function() {
	this.initialize(ss["UWM_neurover2_970x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._970x250neuro2();
...
// stage content:
(lib.UWM_neurover2_970x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(924.65,139.1,1.3324,1.3324,0,0,0,0,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({regX:0.1,x:663.8},7,cjs.Ease.quadOut).wait(20));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_970x250_atlas_NP_1.jpg", id:"UWM_neurover2_970x250_atlas_NP_1"}
	],
	preloads: []
};
