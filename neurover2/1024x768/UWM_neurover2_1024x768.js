...
lib.ssMetadata = [
		{name:"UWM_neurover2_1024x768_atlas_NP_1", frames: [[0,0,2048,1536]]}
];
...
(lib._1024x768neuro2 = function() {
	this.initialize(ss["UWM_neurover2_1024x768_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._1024x768neuro2();
...
// stage content:
(lib.UWM_neurover2_1024x768 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_9.setTransform(1022.4,692.1,1.5246,1.5246,0,0,0,0.1,15.8);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(214).to({_off:false},0).to({x:760.15},7,cjs.Ease.quadOut).wait(44));
...
p.nominalBounds = new cjs.Rectangle(-229.1,383.5,1439.6999999999998,422.9);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_1024x768_atlas_NP_1.jpg", id:"UWM_neurover2_1024x768_atlas_NP_1"}
	],
	preloads: []
};
