...
if (reversed == null) { reversed = false; }
	...
	this.instance_9.setTransform(1002.4,706.1,1.5246,1.5246,0,0,0,0.1,15.8);
	this.instance_9._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(214).to({_off:false},0).to({x:700.15},7,cjs.Ease.quadOut).wait(44));
...
p.nominalBounds = new cjs.Rectangle(-229.1,383.5,1636.8999999999999,422.9);
// library properties:
lib.properties = {
