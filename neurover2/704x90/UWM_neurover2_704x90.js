...
lib.ssMetadata = [
		{name:"UWM_neurover2_704x90_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90neuro2 = function() {
	this.initialize(ss["UWM_neurover2_704x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_neurover2_704x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(670.05,21.8,1,1,0,0,0,0,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({x:475.65},7,cjs.Ease.quadOut).wait(20));
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_160 = new cjs.Graphics().p("AmgFoIBHmWIABAAIAXiGMAnfAAAIhfIcg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(160).to({graphics:mask_graphics_160,x:220.603,y:36.0293}).wait(105));
	...
	mask_1._off = true;
	var mask_1_graphics_112 = new cjs.Graphics().p("AmgFoIBHmWIABAAIAXiGMAnfAAAIhfIcg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(112).to({graphics:mask_1_graphics_112,x:220.603,y:36.0293}).wait(48).to({graphics:null,x:0,y:0}).wait(105));
	...
	mask_2._off = true;
	var mask_2_graphics_64 = new cjs.Graphics().p("AmgFoIBHmWIABAAIAXiGMAnfAAAIhfIcg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(64).to({graphics:mask_2_graphics_64,x:220.603,y:36.0293}).wait(48).to({graphics:null,x:0,y:0}).wait(153));
	...
	mask_3._off = true;
	var mask_3_graphics_16 = new cjs.Graphics().p("AmgFoIBHmWIABAAIAXiGMAnfAAAIhfIcg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(16).to({graphics:mask_3_graphics_16,x:220.603,y:36.0293}).wait(48).to({graphics:null,x:0,y:0}).wait(201));
...
p.nominalBounds = new cjs.Rectangle(88.9,41.3,794.2,72.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_704x90_atlas_NP_1.jpg", id:"UWM_neurover2_704x90_atlas_NP_1"}
	],
	preloads: []
};
