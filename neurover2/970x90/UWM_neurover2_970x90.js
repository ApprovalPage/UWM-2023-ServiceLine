...
lib.ssMetadata = [
		{name:"UWM_neurover2_970x90_atlas_NP_1", frames: [[0,0,1940,180]]}
];
...
(lib._970x90neuro2 = function() {
	this.initialize(ss["UWM_neurover2_970x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._970x90neuro2();
...
// stage content:
(lib.UWM_neurover2_970x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(946.05,21.8,1,1,0,0,0,0,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({x:739.65},7,cjs.Ease.quadOut).wait(20));

	// HEAD1
	this.instance_4 = new lib.HEAD1();
	this.instance_4.setTransform(523.25,17.95,1.35,1.35);
	...
	var mask = new cjs.Shape();
	mask._off = true;
	var mask_graphics_160 = new cjs.Graphics().p("AgSGXIBfokIABAAIAfi1MA1VAAAIiALZg");

	this.timeline.addTween(cjs.Tween.get(mask).to({graphics:null,x:0,y:0}).wait(160).to({graphics:mask_graphics_160,x:352.1784,y:40.7392}).wait(105));

	// HEAD2d
	this.instance_5 = new lib.HEAD2d();
	this.instance_5.setTransform(305.2,36.2,1.35,1.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(160).to({_off:false},0).to({x:523.25},7,cjs.Ease.quadOut).wait(98));

	// mask (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	var mask_1_graphics_112 = new cjs.Graphics().p("AgSGXIBfokIABAAIAfi1MA1VAAAIiALZg");

	this.timeline.addTween(cjs.Tween.get(mask_1).to({graphics:null,x:0,y:0}).wait(112).to({graphics:mask_1_graphics_112,x:352.1784,y:40.7392}).wait(48).to({graphics:null,x:0,y:0}).wait(105));

	// HEAD2c
	this.instance_6 = new lib.HEAD2c();
	this.instance_6.setTransform(301.85,36.85,1.35,1.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(112).to({_off:false},0).to({x:523.25},7,cjs.Ease.quadOut).wait(33).to({x:301.85},7,cjs.Ease.quadIn).to({_off:true},1).wait(105));

	// mask (mask)
	var mask_2 = new cjs.Shape();
	mask_2._off = true;
	var mask_2_graphics_64 = new cjs.Graphics().p("AgSGXIBfokIABAAIAfi1MA1VAAAIiALZg");

	this.timeline.addTween(cjs.Tween.get(mask_2).to({graphics:null,x:0,y:0}).wait(64).to({graphics:mask_2_graphics_64,x:352.1784,y:40.7392}).wait(48).to({graphics:null,x:0,y:0}).wait(153));

	// HEAD2b
	this.instance_7 = new lib.HEAD2b();
	this.instance_7.setTransform(301.85,36.85,1.35,1.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(64).to({_off:false},0).to({x:523.25},7,cjs.Ease.quadOut).wait(33).to({x:301.85},7,cjs.Ease.quadIn).to({_off:true},1).wait(153));

	// mask (mask)
	var mask_3 = new cjs.Shape();
	mask_3._off = true;
	var mask_3_graphics_16 = new cjs.Graphics().p("AgSGXIBfokIABAAIAfi1MA1VAAAIiALZg");

	this.timeline.addTween(cjs.Tween.get(mask_3).to({graphics:null,x:0,y:0}).wait(16).to({graphics:mask_3_graphics_16,x:352.1784,y:40.7392}).wait(48).to({graphics:null,x:0,y:0}).wait(201));

	// HEAD2a
	this.instance_8 = new lib.HEAD2a();
	this.instance_8.setTransform(301.85,36.85,1.35,1.35);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(16).to({_off:false},0).to({x:523.25},7,cjs.Ease.quadOut).wait(33).to({x:301.85},7,cjs.Ease.quadIn).to({_off:true},1).wait(201));
...
p.nominalBounds = new cjs.Rectangle(238.7,41.3,920.3999999999999,72.7);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_970x90_atlas_NP_1.jpg", id:"UWM_neurover2_970x90_atlas_NP_1"}
	],
	preloads: []
};
