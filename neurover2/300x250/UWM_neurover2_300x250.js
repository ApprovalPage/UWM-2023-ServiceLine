...
lib.ssMetadata = [
		{name:"UWM_neurover2_300x250_atlas_NP_1", frames: [[0,0,600,500]]}
];
...
(lib._300x250neuro2 = function() {
	this.initialize(ss["UWM_neurover2_300x250_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x250neuro2();
...
// stage content:
(lib.UWM_neurover2_300x250 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_13.setTransform(150,111);
...
p.nominalBounds = new cjs.Rectangle(-231.5,111,750.6,183);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_300x250_atlas_NP_1.jpg", id:"UWM_neurover2_300x250_atlas_NP_1"}
	],
	preloads: []
};
