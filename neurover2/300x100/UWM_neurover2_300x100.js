...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(266.05,26.8,1,1,0,0,0,0,15.8);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({x:58.65},7,cjs.Ease.quadOut).wait(20));
...
p.nominalBounds = new cjs.Rectangle(-155,46,634.1,68.3);
// library properties:
lib.properties = {
