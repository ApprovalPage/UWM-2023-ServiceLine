...
if (reversed == null) { reversed = false; }
	...
	this.instance_5.setTransform(487.85,260.2,1.28,1.28,0,0,0,0.1,15.8);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(238).to({_off:false},0).to({x:302.1},7,cjs.Ease.quadOut).wait(20));
