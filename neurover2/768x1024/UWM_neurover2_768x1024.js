...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(203).to({x:251.3},7,cjs.Ease.quadInOut).wait(55));

	// CTA
	this.instance_3 = new lib.CTA();
	this.instance_3.setTransform(746.4,964.1,1.5246,1.5246,0,0,0,0.1,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(214).to({_off:false},0).to({x:395.15},7,cjs.Ease.quadOut).wait(44));
...
p.nominalBounds = new cjs.Rectangle(-83.6,511.5,1154.6,550.5);
// library properties:
lib.properties = {
