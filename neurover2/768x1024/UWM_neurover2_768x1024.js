...
lib.ssMetadata = [
		{name:"UWM_neurover2_768x1024_atlas_NP_1", frames: [[0,0,1536,2048]]}
];
...
(lib._768x1024neuro2 = function() {
	this.initialize(ss["UWM_neurover2_768x1024_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._768x1024neuro2();
...
if (reversed == null) { reversed = false; }
	...
	this.shape_1.setTransform(63.675,9.9);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#2F1065").s().p("AAPAtIgWgfIgGAAIgDgBIAAAgIgYAAIAAhWIAPgCIARgBQAUAAAKAIQALAGAAAPQAAAKgFAFQgEAGgIAEIAZAjgAgQgaIAAAYIAKAAQAHAAAFgDQAEgDAAgHQAAgGgEgDQgFgDgHAAIgKABg");
	this.shape_2.setTransform(54.85,9.85);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#2F1065").s().p("AAYAsIgIgWIggAAIgGAWIgZAAIAehXIAjAAIAeBXgAALAEIgLgiIgKAiIAVAAg");
	this.shape_3.setTransform(44.8,9.9);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#2F1065").s().p("AgXAiQgNgKABgXQgBgPAHgKQAFgKANgGQALgEARgBQAKABAJACIAAASIgSgBQgKAAgGACQgGADgDAGQgDAGAAAIQAAAKADAFQAEAGAEADQAHACAJAAQAJAAAKgCIAAATIgKACIgKABQgaAAgNgMg");
	this.shape_4.setTransform(35.6,9.9);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#2F1065").s().p("AghAsIAAhXIAZAAIAABEIAqAAIAAATg");
	this.shape_5.setTransform(23.975,9.9);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#2F1065").s().p("AAYAsIgIgWIggAAIgGAWIgZAAIAehXIAjAAIAeBXgAALAEIgLgiIgKAiIAVAAg");
	this.shape_6.setTransform(14.65,9.9);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#2F1065").s().p("AgWAiQgOgKAAgXQABgPAFgKQAHgKALgGQAMgEAQgBQALABAKACIAAASIgSgBQgKAAgHACQgFADgDAGQgEAGAAAIQAAAKADAFQADAGAGADQAGACAJAAQAKAAAKgCIAAATIgLACIgLABQgZAAgMgMg");
	this.shape_7.setTransform(5.4,9.9);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#2F1065").s().p("AgLAsIAAhXIAYAAIAABXg");
	this.shape_8.setTransform(-1.1,9.9);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#2F1065").s().p("AgaAiQgOgLABgWQgBgWAOgMQAPgMAbAAQALABAKACIAAATQgJgCgKAAQgMAAgGACQgHADgEAGQgDAGAAAJQAAANAHAHQAHAGAOAAIADAAIAAgZIAYAAIAAApQgOACgMABQgbAAgOgMg");
	this.shape_9.setTransform(-8.3,9.9);
	...
	this.shape_10.setTransform(-18.375,9.9);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#2F1065").s().p("AghAsIAAhXIAZAAIAABEIAqAAIAAATg");
	this.shape_11.setTransform(-27.425,9.9);
	...
	this.shape_12.setTransform(-37.075,9.9);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#2F1065").s().p("AAOAtIgVgfIgGAAIgCgBIAAAgIgZAAIAAhWIAQgCIAPgBQAUAAALAIQALAGAAAPQAAAKgEAFQgFAGgJAEIAaAjgAgPgaIAAAYIAJAAQAHAAAFgDQAEgDAAgHQAAgGgEgDQgFgDgHAAIgJABg");
	this.shape_13.setTransform(-46.8,9.85);

	this.shape_14 = new cjs.Shape();
	this.shape_14.graphics.f("#2F1065").s().p("AgeAkQgKgKAAgUIAAgyIAYAAIAAA1QAAAJAEAEQAFAEAHAAQAJAAAEgEQAFgEgBgJIAAg1IAZAAIAAAyQAAAUgKAKQgLAJgVAAQgUAAgKgJg");
	this.shape_14.setTransform(-56.9,9.95);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#2F1065").s().p("AgiAsIAAhXIBFAAIAAASIgtAAIAAAQIAmAAIAAARIgmAAIAAASIAtAAIAAASg");
	this.shape_15.setTransform(-66.225,9.9);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#2F1065").s().p("AASAsIgkg1IAAA1IgYAAIAAhXIAZAAIAlA1IAAg1IAXAAIAABXg");
	this.shape_16.setTransform(-75.925,9.9);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#2F1065").s().p("AgLAsIAAhEIgdAAIAAgTIBSAAIAAATIgdAAIAABEg");
	this.shape_17.setTransform(-89.3,9.9);

	this.shape_18 = new cjs.Shape();
	this.shape_18.graphics.f("#2F1065").s().p("AgiAsIAAhXIBFAAIAAASIgtAAIAAAQIAmAAIAAARIgmAAIAAASIAtAAIAAASg");
	this.shape_18.setTransform(-97.925,9.9);

	this.shape_19 = new cjs.Shape();
	this.shape_19.graphics.f("#2F1065").s().p("AgaAiQgNgLAAgWQAAgWANgMQAPgMAbAAQALABAKACIAAATQgJgCgKAAQgMAAgGACQgHADgDAGQgEAGAAAJQAAANAHAHQAHAGAOAAIADAAIAAgZIAYAAIAAApQgOACgLABQgcAAgOgMg");
	this.shape_19.setTransform(-107.4,9.9);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_19},{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.CTA, new cjs.Rectangle(-114.1,0,209.89999999999998,19), null);
...
// stage content:
(lib.UWM_neurover2_768x1024 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(203).to({x:191.3},7,cjs.Ease.quadInOut).wait(55));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(214).to({_off:false},0).to({x:545.15},7,cjs.Ease.quadOut).wait(44));
...
p.nominalBounds = new cjs.Rectangle(-83.6,511.5,1005.9,550.5);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_768x1024_atlas_NP_1.jpg", id:"UWM_neurover2_768x1024_atlas_NP_1"}
	],
	preloads: []
};
