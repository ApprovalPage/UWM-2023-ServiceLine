...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({x:602.65},7,cjs.Ease.quadOut).wait(20));
...
p.nominalBounds = new cjs.Rectangle(124.9,41.3,805.5,72.7);
// library properties:
lib.properties = {
