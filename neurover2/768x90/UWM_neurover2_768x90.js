...
if (reversed == null) { reversed = false; }
	...
	this.instance_3.setTransform(854.05,21.8,1,1,0,0,0,0,15.8);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(238).to({_off:false},0).to({x:642.65},7,cjs.Ease.quadOut).wait(20));
...
p.nominalBounds = new cjs.Rectangle(184.9,41.3,785.5,72.7);
// library properties:
lib.properties = {
