...
lib.ssMetadata = [
		{name:"UWM_neurover2_300x600_atlas_NP_1", frames: [[0,0,600,1200]]}
];
...
(lib._300x600neuro2 = function() {
	this.initialize(ss["UWM_neurover2_300x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x600neuro2();
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(43.075,24.375);
	...
	this.shape_1.setTransform(29.975,24.375);
	...
	this.shape_2.setTransform(16.95,24.275);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_3.setTransform(3.175,24.375);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#32006E").s().p("Ag0BGIAAiLIAnAAIAABtIBCAAIAAAeg");
	this.shape_4.setTransform(-9.425,24.375);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#32006E").s().p("AgTBGIAAiLIAmAAIAACLg");
	this.shape_5.setTransform(-19.55,24.375);
	...
	this.shape_11.setTransform(18.025,6.625);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_12.setTransform(5.325,6.625);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#32006E").s().p("AAWBHIgigxIgJAAIgEAAIAAAxIgnAAIAAiIIAYgEIAagBQAgAAARALQARAMAAAXQAAAPgHAJQgHAKgOAGIApA3gAgZgqIAAAlIAOABQAOAAAGgEQAHgFgBgLQABgKgHgFQgGgFgNAAQgIAAgHACg");
	this.shape_13.setTransform(-8.45,6.525);
	...
	this.shape_14.setTransform(-24.275,6.725);

	this.shape_15 = new cjs.Shape();
	this.shape_15.graphics.f("#32006E").s().p("Ag5BGIAAgUIBAhZIg/AAIAAgeIByAAIAAAUIhBBZIBCAAIAAAeg");
	this.shape_15.setTransform(-38.9,6.625);

	this.shape_16 = new cjs.Shape();
	this.shape_16.graphics.f("#32006E").s().p("AgTBGIAAiLIAnAAIAACLg");
	this.shape_16.setTransform(-48.95,6.625);

	this.shape_17 = new cjs.Shape();
	this.shape_17.graphics.f("#32006E").s().p("Ag3BGIAAiLIBuAAIAAAdIhHAAIAAAZIA8AAIAAAcIg8AAIAAAcIBIAAIAAAdg");
	this.shape_17.setTransform(-58.775,6.625);
	...
	this.shape_18.setTransform(-72.025,6.625);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_18},{t:this.shape_17},{t:this.shape_16},{t:this.shape_15},{t:this.shape_14},{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD2b, new cjs.Rectangle(-94.5,-7.9,189.1,45.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(56.775,5.2);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#32006E").s().p("AgMAsIAAhYIAYAAIAABYg");
	this.shape_1.setTransform(49.35,5.2);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAASIAtAAIAAASg");
	this.shape_2.setTransform(39.325,5.2);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#32006E").s().p("AgkAsIAAgMIAog5IgoAAIAAgTIBIAAIAAAOIgoA3IApAAIAAATg");
	this.shape_3.setTransform(30.6,5.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#32006E").s().p("AgLAsIAAhYIAYAAIAABYg");
	this.shape_4.setTransform(24.1,5.2);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#32006E").s().p("AghAsIAAhYIAZAAIAABFIAqAAIAAATg");
	this.shape_5.setTransform(18.275,5.2);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#32006E").s().p("AAYAsIgHgVIghAAIgHAVIgXAAIAdhYIAjAAIAdBYgAALAFIgLgiIgKAiIAVAAg");
	this.shape_6.setTransform(8.95,5.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#32006E").s().p("AgLAsIAAhYIAXAAIAABYg");
	this.shape_7.setTransform(1.75,5.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#32006E").s().p("AgXAiQgNgLABgXQAAgNAFgLQAHgKALgFQAMgGARAAQAKAAAKACIAAATIgSgCQgLAAgGADQgGADgDAGQgDAGAAAIQAAAJADAGQAEAGAEADQAHADAKgBQAIABALgDIAAATIgKACIgLAAQgZAAgOgLg");
	this.shape_8.setTransform(-4.65,5.2);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAASIAtAAIAAASg");
	this.shape_9.setTransform(-13.175,5.2);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f("#32006E").s().p("AgkAtIAAhWQAQgDAOAAQAWAAALAIQAKAIAAARQAAAPgKAIQgLAIgTAAIgGAAIgCAAIAAAZgAgLgaIAAAdIAIAAQAIAAAEgDQAFgDAAgIQAAgJgFgDQgEgEgIAAg");
	this.shape_10.setTransform(-22.025,5.15);

	this.shape_11 = new cjs.Shape();
	this.shape_11.graphics.f("#32006E").s().p("AgSAsIgOgCIAAgSIAOACIAOABQAHAAAEgCQADgCAAgEIAAgEIgEgCIgGgDIgIgCQgNgDgGgFQgHgHAAgKQAAgNAKgHQALgIAUAAIAMABIALACIAAATIgLgDIgLAAQgJAAgFACQgDACAAAEIABAEIACACIAGACIAIACQANAEAHAEQAHAHAAAKQAAAJgFAHQgFAGgIADQgJADgMAAIgOgBg");
	this.shape_11.setTransform(-30.75,5.2);

	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f("#32006E").s().p("AgiAsIAAhYIBFAAIAAATIgtAAIAAAQIAmAAIAAARIgmAAIAAASIAtAAIAAASg");
	this.shape_12.setTransform(-42.575,5.2);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#32006E").s().p("AASAsIgSg+IgRA+IgfAAIgZhYIAZAAIARBDIAThDIAaAAIASBEIAShEIAYAAIgZBYg");
	this.shape_13.setTransform(-54.725,5.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_13},{t:this.shape_12},{t:this.shape_11},{t:this.shape_10},{t:this.shape_9},{t:this.shape_8},{t:this.shape_7},{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.HEAD1, new cjs.Rectangle(-109,-4.7,218,19), null);
...
// stage content:
(lib.UWM_neurover2_300x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_3.setTransform(496.05,496.8,1,1,0,0,0,0,15.8);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(4).to({_off:false},0).to({x:141},10,cjs.Ease.quadOut).wait(251));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(160).to({_off:false},0).to({x:141},7,cjs.Ease.quadOut).wait(98));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(1).to({_off:false},0).to({x:74.15},10,cjs.Ease.quadOut).wait(254));
...
p.nominalBounds = new cjs.Rectangle(-231.5,299.5,789.4,301);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover2_300x600_atlas_NP_1.jpg", id:"UWM_neurover2_300x600_atlas_NP_1"}
	],
	preloads: []
};
