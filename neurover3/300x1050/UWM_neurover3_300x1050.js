...
lib.ssMetadata = [
		{name:"UWM_neurover3_300x1050_atlas_NP_1", frames: [[0,0,600,2100]]}
];
...
(lib._300x1050neuro3 = function() {
	this.initialize(ss["UWM_neurover3_300x1050_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._300x1050neuro3();
...
// stage content:
(lib.UWM_neurover3_300x1050 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover3_300x1050_atlas_NP_1.jpg", id:"UWM_neurover3_300x1050_atlas_NP_1"}
	],
	preloads: []
};
