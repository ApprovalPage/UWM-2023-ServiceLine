...
lib.ssMetadata = [
		{name:"UWM_neurover3_120x600_atlas_NP_1", frames: [[0,0,240,1200]]}
];
...
(lib._120x600neuro3 = function() {
	this.initialize(ss["UWM_neurover3_120x600_atlas_NP_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Layer_1
	this.instance = new lib._120x600neuro3();
...
// stage content:
(lib.UWM_neurover3_120x600 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.instance_4.setTransform(-133,408,1.14,1.14);
	this.instance_4._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_4).wait(160).to({_off:false},0).to({x:60},7,cjs.Ease.quadOut).wait(41).to({y:415.55},13,cjs.Ease.quadInOut).wait(44));

	// HEAD2c
	this.instance_5 = new lib.HEAD2c();
	this.instance_5.setTransform(-95.85,408.1,1.14,1.14);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover3_120x600_atlas_NP_1.jpg", id:"UWM_neurover3_120x600_atlas_NP_1"}
	],
	preloads: []
};
