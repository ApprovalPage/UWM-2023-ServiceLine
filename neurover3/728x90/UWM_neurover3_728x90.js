...
lib.ssMetadata = [
		{name:"UWM_neurover3_728x90_atlas_NP_1", frames: [[0,0,1456,180]]}
];
...
(lib._728x90neuro3 = function() {
	this.initialize(ss["UWM_neurover3_728x90_atlas_NP_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.UWM_neurover3_728x90 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/UWM_neurover3_728x90_atlas_NP_1.jpg", id:"UWM_neurover3_728x90_atlas_NP_1"}
	],
	preloads: []
};
