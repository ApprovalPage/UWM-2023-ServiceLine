...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(222).to({_off:false},0).to({x:104.65},7,cjs.Ease.quadOut).wait(20));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(64).to({_off:false},0).to({x:147},7,cjs.Ease.quadOut).wait(33).to({x:-17},7,cjs.Ease.quadIn).to({_off:true},1).wait(137));
